...
namespace MailSender.TestConsole
{
    class Program
    {
        ...
        static void Main (string[] args)
        {
            ...
            print_info.Invoke(printer_obj0, new object[] { "World!!!" });
            print_info.Invoke(printer_obj1, new object[] { "World!!!" });
        ...
        private static void ProcessValue(string v) => Console.WriteLine("string:{0}", v);
